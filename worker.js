...
<body>
  ...
  <script>
    const DESTINATIONS = { '1':'South Ferry','2':'Flatbush Av','3':'New Lots Av','B':'Brighton Beach','C':'Euclid Av' };
    const STATION = { '1':'96 St / Broadway','2':'96 St / Broadway','3':'96 St / Broadway','B':'96 St / CPW','C':'96 St / CPW' };
...
async function getTrains() {
  ...
  const COLORS = { '1':'#EE352E','2':'#EE352E','3':'#EE352E','B':'#FF6319','C':'#0039A6' };
  const dec = new TextDecoder();
    ...
    try {
      ...
      for (const entityBytes of (feedMsg[2] || [])) {
        ...
        for (const stuBytes of (tu[2] || [])) {
          ...
          if (dec.decode(stu[2][0]) !== feed.stopId) continue;
